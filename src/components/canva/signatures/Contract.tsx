...
export default function ContractSignedDocument({
	documentContract,
	modal,
	setModal,
	cnpj,
			...
			try {
				...
				if (document && sectionRef.current && canvasRef.current) {
					...
					const canvaDocument = await loadImage(
						documentContract.type === 'pdf'
							? documentContract.picture
	...
	return (
		<>
			<Modal isOpen={modalContract} setIsOpen={setModalContract} size='lg'>
			...
			<Modal isOpen={modal} setIsOpen={setModal} fullScreen isStaticBackdrop>
