...
<div className='link-list'>
	...
	<span className='link-item'>
		...
		<span>
			...
			You can easily include 16 different types of graphics in your project and have
			harmonious designs.
		</span>
	</span>
	<span className='link-item'>
	...
	<span className='link-item'>
		...
		<span>
			...
			You can always get answers to your questions.{' '}
			<a href='mailto:info@omtanke.studio'>info@omtanke.studio</a>.
		</span>
	</span>
</div>
