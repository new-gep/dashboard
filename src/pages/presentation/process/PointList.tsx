			...
			<SubHeader>
				<SubHeaderLeft>
					...
					<span className='text-muted'>
					    Mantenha-se organizado e nunca perca um compromisso com nosso calendário intuitivo e fácil de usar.
					</span>
				</SubHeaderLeft>
							...
							<DatePicker
								...
								locale={{
									localize: {
										...
										quarter: () => {},
                                        //@ts-ignore
										month: (n) => dayjs().localeData().months()[n].charAt(0).toUpperCase() + dayjs().localeData().months()[n].slice(1),
										day: () => {},
										dayPeriod: () => {},
									},
									formatLong: {
