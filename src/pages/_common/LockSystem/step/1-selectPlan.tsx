                    ...
                    <div className='h-100 d-flex align-items-center justify-content-center'>
                        <div className='row text-center'>
                            ...
                            <div className='col-12 text-uppercase h2 fw-bold mb-2'>
                                Selecione o <br/><span className='text-success'>seu</span><br/> plano perfeito
                            </div>
                            <div className='col-12 mb-2'>
                                Otimize processos, reduza retrabalho e tenha mais eficiência na gestão de pessoas. Nosso sistema automatiza tarefas 
                                repetitivas e melhora a tomada de decisões. Assine agora e leve o RH da sua empresa para o próximo nível!
                            </div>
