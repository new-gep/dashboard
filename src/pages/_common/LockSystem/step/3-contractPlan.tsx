...
export default function ContractPlan(props: ContractPlanProps){
    ...
    return(
        <div>
            ...
            <p className="mb-4 text-muted">Na próxima etapa, você encontrará o contrato para assinatura com a empresa New GEP.</p>
            <div className='d-flex flex-column justify-content-center align-items-center'>
                <img src={Laptop} alt="Laptop" className='img-fluid' style={{maxHeight: '50vh', width: 'auto', marginLeft: '9%'}} />
                {
                    document ?
                    <Button 
